...
class TextStyles {
  static TextStyle heading32 ({Color? color}) => TextStyle(
      color: color ?? Constants.textColor,
      fontFamily: Constants.fontBold,
      fontSize: Constants.text32,
      fontWeight: FontWeight.bold);
  static TextStyle heading28({Color? color}) => TextStyle(
      color: color ?? Constants.textColor,
      fontFamily: Constants.fontBold,
      fontSize: Constants.text28);
  static TextStyle heading24({Color? color}) => TextStyle(
      color: color ?? Constants.textColor,
      fontFamily: Constants.fontMedium,
      fontSize: Constants.text24);
  static TextStyle pageTitle({Color? color}) => TextStyle(
      color: color ?? Constants.textColor,
      fontFamily: Constants.fontMedium,
      fontSize: Constants.text22);
  static TextStyle headingText ({Color? color, FontWeight? weight}) => TextStyle(
      color: color ?? Constants.textColor,
      fontFamily: Constants.fontMedium,
      fontSize: Constants.extraLarge);
